...
"<li><button class='getmatch btn btn-default' onClick='get.closestMatch()'>Get Closest Match</button></li>",
"<li><button class='getopp btn btn-default' onClick='get.oppositeMatch()'>Get Opposite Match</button></li>",
"<li><button class='delete btn btn-default' onClick='events.deleteUser()'>Delete Account</button></li>",
"</ul>",
